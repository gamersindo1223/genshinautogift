...
async function getuid() {
    ...
    return new Promise(resolve => {
        ...
        xhr.open("GET", "https://api-account-os.hoyoverse.com/account/binding/api/getUserGameRolesByCookieToken?lang=en&region=os_asia&game_biz=hk4e_global&sLangKey=en-us");

        xhr.setRequestHeader("Accept", "application/json, text/plain, */*");

        xhr.setRequestHeader("Accept-Language", "en-US,en;q=0.9,id-ID;q=0.8,id;q=0.7");
